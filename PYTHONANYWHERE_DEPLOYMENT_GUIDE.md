...
### Собственный домен voltfighters.ru:
1. Откройте ваш сайт: `https://voltfighters.ru`
2. Проверьте API: `https://voltfighters.ru/api/fighters`
3. Проверьте документацию: `https://voltfighters.ru/docs`

**Для подключения собственного домена нужен платный план PythonAnywhere ($5/месяц минимум)**
...
## 🌐 Подключение собственного домена voltfighters.ru

Для подключения домена `voltfighters.ru` выполните следующие шаги:

### 1. Обновите план PythonAnywhere
- Нужен **платный план** (минимум $5/месяц)
- Перейдите в раздел "Account" → "Upgrade"
...
### 3. Настройте домен в PythonAnywhere
1. В разделе **Web** → **Domains** добавьте:
   - `voltfighters.ru`
   - `www.voltfighters.ru`
...
**Подробная инструкция:** `DOMAIN_SETUP_GUIDE.md`
