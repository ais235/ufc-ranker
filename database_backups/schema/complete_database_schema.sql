-- ПОЛНАЯ СХЕМА БАЗЫ ДАННЫХ UFC RANKER
-- Создано: 2024-09-24
-- Версия: 3.0 (совместима со всеми парсерами)
-- Источник: анализ всех парсеров проекта
...
-- Таблица детальной информации о боях бойцов
...
-- Таблица боев событий (альтернативная структура)
...
CREATE INDEX IF NOT EXISTS idx_fighter_fights_fighter ON fighter_fights(fighter_id);
CREATE INDEX IF NOT EXISTS idx_event_fights_event ON event_fights(event_id);
...
CREATE TRIGGER IF NOT EXISTS update_event_fights_timestamp 
    AFTER UPDATE ON event_fights
    BEGIN
        UPDATE event_fights SET updated_at = CURRENT_TIMESTAMP WHERE id = NEW.id;
    END;
...
INSERT OR IGNORE INTO weight_classes (name_ru, name_en, full_name, weight_min, weight_max, weight_limit, gender) VALUES
('Тяжелый вес', 'Heavyweight', 'Heavyweights', 93, 120, 265, 'male'),
('Полутяжелый вес', 'Light Heavyweight', 'Light Heavyweights', 84, 93, 205, 'male'),
('Средний вес', 'Middleweight', 'Middleweights', 77, 84, 185, 'male'),
('Полусредний вес', 'Welterweight', 'Welterweights', 70, 77, 170, 'male'),
('Легкий вес', 'Lightweight', 'Lightweights', 66, 70, 155, 'male'),
('Полулегкий вес', 'Featherweight', 'Featherweights', 61, 66, 145, 'male'),
('Легчайший вес', 'Bantamweight', 'Bantamweights', 57, 61, 135, 'male'),
('Наилегчайший вес', 'Flyweight', 'Flyweights', 52, 57, 125, 'male'),
('Женский легчайший вес', 'Women''s Bantamweight', 'Women''s Bantamweights', 57, 61, 135, 'female'),
('Женский наилегчайший вес', 'Women''s Flyweight', 'Women''s Flyweights', 52, 57, 125, 'female'),
('Женский минимальный вес', 'Women''s Strawweight', 'Women''s Strawweights', 48, 52, 115, 'female');
